...
export function RightEffect(props: SVGProps<SVGSVGElement>) {
  const { colors } = useTheme()
  return (
    <svg width={371} height={236} fill="none" {...props}>
      <rect
        width={61}
        height={3}
        rx={1.5}
      ...
      <rect
        ...
        fillOpacity={0.14}
      />
      <rect x={91} width={38} height={3} rx={1.5} fill={colors.svg} fillOpacity={0.14} />
      <rect
        x={196}
        y={189}
        width={41}
